...
var DateRange = (function (_Component) {
  ...
  function DateRange(props, context) {
    ...
    var pickSingleDate = props.pickSingleDate;

    var startDate = (0, _utilsParseInputJs2['default'])(props.startDate, format);
    var endDate = pickSingleDate ? (0, _utilsParseInputJs2['default'])(props.startDate, format) : (0, _utilsParseInputJs2['default'])(props.endDate, format);
  ...
  _createClass(DateRange, [{
    ...
    value: function setRange(range, source) {
      ...
      var pickSingleDate = _props.pickSingleDate;
    ...
    value: function render() {
      ...
      var linkedCalendars = _props2.linkedCalendars;
      var style = _props2.style;
      var calendars = _props2.calendars;
      ...
      var showIndex = _props2.showIndex;
      var yearRange = _props2.yearRange;
      var selectYear = _props2.selectYear;
      ...
      return _react2['default'].createElement(
        ...
        ranges && _react2['default'].createElement(_PredefinedRangesJs2['default'], {
          ...
          classNames: classes }),
        (function () {
          var _calendars = [].concat(_toConsumableArray(Array(calendars).keys())).map(function (i) {
            var offset = i - showIndex;
            return _react2['default'].createElement(_CalendarJs2['default'], {
              key: i,
              index: i,
              offset: offset,
              changeYear: _this.changeYear.bind(_this),
...
DateRange.propTypes = {
  selectYear: _react.PropTypes.bool,
  pickSingleDate: _react.PropTypes.bool,
  showIndex: _react.PropTypes.number,
