...
var Calendar = (function (_Component) {
  ...
  function Calendar(props, context) {
    ...
    var test = range && range['endDate'] || date;
  ...
  _createClass(Calendar, [{
    ...
    value: function renderMonthAndYear(classes) {
      ...
      var calendarEnd = _props4.calendarEnd;
      var pickSingleDate = _props4.pickSingleDate;
      var changeYear = _props4.changeYear;
      var yearRange = _props4.yearRange;
      var selectYear = _props4.selectYear;

      var start = index === 0;
      var end = index === calendarEnd;

      var showStart = undefined,
          showEnd = undefined;
      ...
      var generateYearRange = function generateYearRange() {
        var yearOptions = [];
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'button',
          {
            style: onlyClasses ? undefined : _extends({}, styles['MonthButton'], showStart, { float: 'left' }),
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            start && pickSingleDate && selectYear ? _react2['default'].createElement(
              'select',
              { onChange: changeYear, value: year },
              generateYearRange()
            ) : year
          )
        ),
        _react2['default'].createElement(
          'button',
          {
            style: onlyClasses ? undefined : _extends({}, styles['MonthButton'], showEnd, { float: 'right' }),
